...
class Button {
  public:
    ...
    Button(uint8_t buttonPin, uint8_t buttonMode, bool _debounceMode, int _debounceDuration, std::vector<uint32_t> _buttonLimits);
    ...
    inline unsigned int keyValue() const { return latchedKey; }
